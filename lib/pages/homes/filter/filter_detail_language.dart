...
class FilterDetailLanguageView extends GetView<FilterController> {
  final FilterController c = Get.put(FilterController());

  FilterDetailLanguageView({Key? key}) : super(key: key);
        ...
        children: [
          Column(
            ...
            children: [
              ...
              for (var i = 0; i < c.arrLanguage.length; i++)
                Column(
                  children: [
                    Container(
                      ...
                      child: Row(
                        children: [
                          Container(
                            ...
                            child: Obx(() {
                              return Checkbox(
                                value: c.arrLanguageCheck[i].value,
                                checkColor: AppTheme.colorWhite,
                                onChanged: (_value) {
                                  c.arrLanguageCheck[i].value = _value!;
                                },
